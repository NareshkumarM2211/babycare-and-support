 		...
 		<div class="row">
 				<div class="col-md-4"><!-- left -->
 						<div class="list-group"><!-- products -->
						  ...
						  <a href="Controller?page=dress" class="list-group-item" style="background:  #d6d4d3";>Dress</a>
 				...
 				<div class="col-md-8"><!-- right -->
 					<h2 style="text-align: center;">Dress</h2><br>
					...
					<input type="submit" value="Go!">
 					...
 					<c:forEach items="${list }" var="product">
 						...
 						<c:if test="${product.getCategory() == 'dress' }">
		 					...
		 					<div class="col-md-4">
		 						...
		 						<div class="text-center">  <a class="btn btn-primary" href="Controller?page=addtocart&action=dress&id=<c:out value="${product.getId()}"/>">Add to Cart</a> </div><br>
		 					</div>
