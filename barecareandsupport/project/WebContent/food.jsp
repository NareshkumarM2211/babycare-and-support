 		...
 		<div class="row">
 				<div class="col-md-4"><!-- left -->
						 ...
						 <a href="Controller?page=all-products" class="list-group-item">
						    ...
						    <a href="Controller?page=food" class="list-group-item" style="background:  #d6d4d3;">Food</a>
 				...
 				<div class="col-md-8"><!-- right -->
 					<h2 style="text-align: center;">Food</h2><br>
					...
					<input type="submit" value="Go!">
 					...
 					<c:forEach items="${list }" var="product">
 						...
 						<c:if test="${product.getCategory() == 'food' }">
		 					...
		 					<div class="col-md-4">
		 						...
		 						<div class="text-center">  <a class="btn btn-primary" href="Controller?page=addtocart&action=food&id=<c:out value="${product.getId()}"/>">Add to Cart</a> </div><br>
		 					</div>
