 		...
 		<div class="row">
 				<div class="col-md-4"><!-- left -->
 						<div class="list-group"><!-- products -->
						  ...
						  <a href="Controller?page=wetwipes" class="list-group-item">Wet wipes</a>
						  <a href="Controller?page=soap" class="list-group-item" style="background:  #d6d4d3;">Soap-Shampoo</a> 
						  
						</div> 
 				</div><!-- left -->

 				<div class="col-md-8"><!-- right -->
 					<h2 style="text-align: center;">Soap-Shampoo</h2><br>
					...
					<input type="hidden" name="action" value="soap">
					<select name="sort">
					...
					<input type="submit" value="Go!">
 					...
 					<c:forEach items="${list }" var="product">
 						...
 						<c:if test="${product.getCategory() == 'soap' }">
		 					...
		 					<div class="col-md-4">
								...
								<div class="text-center">  <a class="btn btn-primary" href="Controller?page=addtocart&action=soap&id=<c:out value="${product.getId()}"/>">Add to Cart</a> </div><br>		 					</div>
