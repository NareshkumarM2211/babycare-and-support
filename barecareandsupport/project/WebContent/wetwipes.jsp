	...
	<header>
		...
		<nav>
			<ul>
				...
				<li><a style="color:blue" href="Controller?page=product">Product</a></li>
 		...
 		<div class="row">
 				<div class="col-md-4"><!-- left -->
 						<div class="list-group"><!-- products -->
						  <a href="Controller?page=all-products" class="list-group-item">
						    All Products
						  </a>
						  
						   <a href="Controller?page=food" class="list-group-item">Food</a>
						  <a href="Controller?page=dress" class="list-group-item">Dress</a>
						  <a href="Controller?page=wetwipes" class="list-group-item" style="background:  #d6d4d3;">Wet wipes</a>
						  <a href="Controller?page=soap" class="list-group-item" >Soap-Shampoo</a> 
						  
						</div> 
 				</div><!-- left -->

 				<div class="col-md-8"><!-- right -->
 					<h2 style="text-align: center;">Wet wipes</h2><br>
					...
					<input type="hidden" name="action" value="wetwipes">
					<select name="sort">
					...
					<input type="submit" value="Go!">
 					...
 					<c:forEach items="${list }" var="product">
 						...
 						<c:if test="${product.getCategory() == 'wetwipes' }">
		 					...
		 					<div class="col-md-4">
		 						...
		 						<div class="text-center">  <a class="btn btn-primary" href="Controller?page=addtocart&action=wetwipes&id=<c:out value="${product.getId()}"/>">Add to Cart</a> </div><br>
		 					</div>
